...
public:
    ...
    {
        TransactionsFrame->setWindowTitle(QCoreApplication::translate("TransactionsFrame", "Frame", nullptr));
        m_csvButton->setText(QCoreApplication::translate("TransactionsFrame", "Export", nullptr));
    } // retranslateUi
