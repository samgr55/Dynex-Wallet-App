...
public:
    ...
    {
        TransferFrame->setWindowTitle(QCoreApplication::translate("TransferFrame", "Frame", nullptr));
        label->setText(QCoreApplication::translate("TransferFrame", "Pay To:", nullptr));
        m_addressBookButton->setText(QCoreApplication::translate("TransferFrame", "...", nullptr));
        m_pasteButton->setText(QCoreApplication::translate("TransferFrame", "...", nullptr));
        m_labelEdit->setPlaceholderText(QCoreApplication::translate("TransferFrame", "Enter a label for this address to add it to your address book", nullptr));
        label_3->setText(QCoreApplication::translate("TransferFrame", "Amount:", nullptr));
        m_removeButton->setText(QCoreApplication::translate("TransferFrame", "...", nullptr));
        label_2->setText(QCoreApplication::translate("TransferFrame", "Label:", nullptr));
    } // retranslateUi
